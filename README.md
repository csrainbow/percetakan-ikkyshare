# Percetakan Ikky Share Online + Kasir
...
Varian **Percetakan Ikky Share** (toko online: `percetakan-ikkyshare.web.id`).
Varian produksi Percetakan Rainbow tersedia di repo `csrainbow/percetakan-online-kasir`
...
- **Zona waktu default Asia/Jakarta (WIB)** — sesuaikan di `config.php` (mis. `Asia/Makassar`
  untuk Samarinda, seperti varian Rainbow produksi)
