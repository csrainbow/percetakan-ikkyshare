...
if (!function_exists('sendEmail')) {
    function sendEmail($to, $subject, $message) {
        $headers = "From: admin@percetakan-ikkyshare.web.id\r\n";
        $headers .= "Reply-To: admin@percetakan-ikkyshare.web.id\r\n";
    ...
    if ($fraudStatus === 'accept' || $fraudStatus === null || $fraudStatus === '') {
        ...
        try {
            ...
            if ($adminEmail) {
                ...
                $message .= "Link: https://percetakan-ikkyshare.web.id/admin/order-detail.php?id=" . $order['id'];
            ...
            if ($customerEmail) {
                ...
                $message .= "Link: https://percetakan-ikkyshare.web.id/customer/order-detail.php?order=" . $order['order_code'];
