...
try {
    ...
    try {
        ...
        if ($adminEmail) {
            ...
            $message .= "Link: https://percetakan-ikkyshare.web.id/admin/order-detail.php?id=" . $orderId;
    ...
    try {
        ...
        $waMsg = "🛒 *PESANAN BARU (TOKO ONLINE)*\n"
            ...
            . "Detail: https://percetakan-ikkyshare.web.id/admin/order-detail.php?id=" . $orderId;
