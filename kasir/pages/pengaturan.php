...
<div class="grid2">
    ...
    <div class="panel grid-full">
        ...
        <p class="muted kecil">PNG/JPG/WebP, maks 2 MB per gambar. Logo otomatis menyesuaikan orientasi (kotak/bulat/portrait/landscape) tanpa merubah rasio. Tinggi maksimal logo nota A5 dapat diatur di bawah (min 4 mm â€“ maks 16 mm, disarankan 10 mm = seukuran tinggi nama percetakan sampai nomor telepon).</p>
